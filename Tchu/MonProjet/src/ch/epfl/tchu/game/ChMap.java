...
public final class ChMap
{
    ...
    public static List<Station> getAllStationsWithoutCountries () {return ALL_STATIONS_WITHOUT_COUNTRIES;}
    ...
    private static final List<Station> ALL_STATION_COUNTRIES = List.of (DE1, DE2, DE3, DE4, DE5, AT1, AT2, AT3, IT1, IT2, IT3, IT4, IT5, FR1, FR2, FR3, FR4);
    ...
    private static final List<Station> ALL_STATIONS_WITHOUT_COUNTRIES =
            ALL_STATIONS.stream().filter(s -> !ALL_STATION_COUNTRIES.contains(s)).collect(Collectors.toList());
